...
.equ    address_lcd_data   , 0xE000     ; WR# + A15 + A14  + A13  + A12#
.equ    address_led_data   , 0xD000     ; WR# + A15 + A14  + A13# + A12
.equ    address_matrix_data, 0xB000     ; WR# + A15 + A14# + A13  + A12
...
poweron:
    ...
    mov r7, #0x00
  	acall	set_led_data    ; Clear led latch
